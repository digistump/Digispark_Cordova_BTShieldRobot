...
/* global cordova, bluetoothSerial, listButton, connectButton, fSendButton, lSendButton, rSendButton, sSendButton, bSendButton, disconnectButton */
/* global deviceList, messages, statusMessage, chat, connection */
'use strict';
...
var app = {
    ...
    deviceready: function() {
        ...
        fSendButton.ontouchstart = app.sendData;
        lSendButton.ontouchstart = app.sendData;
        rSendButton.ontouchstart = app.sendData;
        sSendButton.ontouchstart = app.sendData;
        bSendButton.ontouchstart = app.sendData;
    ...
    sendData: function(event) {
        ...
        var text = event.target.dataset.send + "\n";
        var success = function () {
            messages.value += ("Us: " + text);
            messages.scrollTop = messages.scrollHeight;
        };

        bluetoothSerial.write(event.target.dataset.send, success);
        return false;
    },
